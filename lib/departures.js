 ...
 * of the SL Transport API. A "site" is a place, not a platform: Skogås (9731)
 * covers the commuter-rail station AND the surrounding bus stops. direction_code
 * is only meaningful *per line*, so the same code means different things for
 * different lines. At Skogås, direction_code 2 is northbound for train line 43
 * (toward Bålsta via Stockholm City) but for buses 742/830/831 it points at
 * Huddinge sjukhus and Farsta centrum — the opposite of "toward town".
 *
 ...
 * default of 3 hides the lift notices that Skogås always carries while still
 * surfacing real disruption.
 *
 * @param {object} d a departure
